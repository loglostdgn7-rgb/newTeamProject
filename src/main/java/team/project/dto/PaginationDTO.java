...
@Setter
@ToString
//김영수님 수정 9/23 PaginationDTO -> PaginationDTO<T>
...
//    private String sort = "wroteAt"; // 정렬 방식
    //김영수님 9/24일 수정 위에서 아래껄로
    private String sort = "{period, status}"; // 정렬 방식
...
//    private final Integer pageViewOffset = 2; // 화면에 보여줄 앞 뒤 페이지 번호 개수
    //김영수님 수정 9/24 위에꺼에서 아래껄로 변경 final->" "
    ...
    //김영수님 수정 9/23  위에꺼에서 아래껄로 수정
    @Setter private List<T> elements; // 페이지네이션 대상 요소
